...
func DecodeUpdateAgentRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*admin.UpdateAgentPayload, error) {
	return func(r *http.Request) (*admin.UpdateAgentPayload, error) {
		var (
...
func DecodeRefreshConfigRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*admin.RefreshConfigPayload, error) {
	return func(r *http.Request) (*admin.RefreshConfigPayload, error) {
		var (
			token string
			err   error
		)
