...
// Refresh endpoint.
func DecodeRefreshRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*catalog.RefreshPayload, error) {
	return func(r *http.Request) (*catalog.RefreshPayload, error) {
		var (
			catalogName string
			token       string
			err         error
...
// RefreshAll endpoint.
func DecodeRefreshAllRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*catalog.RefreshAllPayload, error) {
	return func(r *http.Request) (*catalog.RefreshAllPayload, error) {
		var (
			token string
			err   error
		)
...
func DecodeCatalogErrorRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*catalog.CatalogErrorPayload, error) {
	return func(r *http.Request) (*catalog.CatalogErrorPayload, error) {
		var (
			catalogName string
			token       string
			err         error
