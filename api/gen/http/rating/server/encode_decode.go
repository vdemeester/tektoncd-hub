...
// endpoint.
func DecodeGetRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*rating.GetPayload, error) {
	return func(r *http.Request) (*rating.GetPayload, error) {
		var (
			id    uint
			token string
			err   error
...
// endpoint.
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*rating.UpdatePayload, error) {
	return func(r *http.Request) (*rating.UpdatePayload, error) {
		var (
