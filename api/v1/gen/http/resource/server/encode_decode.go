...
// endpoint.
func DecodeListRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*resource.ListPayload, error) {
	return func(r *http.Request) (*resource.ListPayload, error) {
		var (
			limit uint
			err   error
		)
...
func DecodeByCatalogKindNameVersionReadmeRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*resource.ByCatalogKindNameVersionReadmePayload, error) {
	return func(r *http.Request) (*resource.ByCatalogKindNameVersionReadmePayload, error) {
		var (
			catalog string
			kind    string
			name    string
...
func DecodeByCatalogKindNameVersionYamlRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*resource.ByCatalogKindNameVersionYamlPayload, error) {
	return func(r *http.Request) (*resource.ByCatalogKindNameVersionYamlPayload, error) {
		var (
			catalog string
			kind    string
			name    string
...
func DecodeGetRawYamlByCatalogKindNameVersionRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*resource.GetRawYamlByCatalogKindNameVersionPayload, error) {
	return func(r *http.Request) (*resource.GetRawYamlByCatalogKindNameVersionPayload, error) {
		var (
			catalog string
			kind    string
			name    string
...
func DecodeGetLatestRawYamlByCatalogKindNameRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*resource.GetLatestRawYamlByCatalogKindNamePayload, error) {
	return func(r *http.Request) (*resource.GetLatestRawYamlByCatalogKindNamePayload, error) {
		var (
			catalog string
			kind    string
			name    string
